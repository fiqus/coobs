...
var langDict = {
  en: {
    ...
    "public-actions-header-subtitle": "Find out what cooperatives are doing by reading the actions published on our platform",
    ...
    "public-actions-no-more": "There are no more actions to show.",
    ...
    "fiqusLabsText": "Created with ♥ by Fiqus | COOBS "+(new Date().getFullYear()),
    "help": "Help",
    "helpLoading": "Loading help contents.."
  },
  es : {
    "signIn": "Inicie sesión",
    "header-title-1": "COOBS:",
    "header-title-2": "Balance Social Cooperativo",
    "header-subtitle": "Una herramienta que facilita el seguimiento de las acciones de su organización, guiadas por los principios cooperativos y los objetivos de desarrollo sustentable.",
    "public-actions-button": "¡Mirá al cooperativismo en acción!",
    "public-actions-header-title": "Acciones Cooperativas",
    "public-actions-header-subtitle": "Enterate de lo que están haciendo las cooperativas, leyendo las acciones que publican en nuestra plataforma",
    ...
    "public-actions-no-more": "No hay más acciones para mostrar",
    ...
    "fiqusLabsText": "Creado con ♥ por Fiqus | COOBS "+(new Date().getFullYear()),
    "help": "Ayuda",
